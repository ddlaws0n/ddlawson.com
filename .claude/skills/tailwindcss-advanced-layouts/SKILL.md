...
```html
<div class="grid-areas-dashboard grid min-h-screen grid-cols-[200px_1fr_250px] grid-rows-[60px_1fr_40px]">
...
<div class="mbs-auto pbs-4 pbe-6">Block-direction spacing</div>
```
...
```html
<!-- Fluid padding -->
<section class="px-[clamp(1rem,3vw,4rem)] py-[clamp(2rem,5vw,6rem)]">Content with responsive padding</section>
...
<article class="print:bg-white print:text-black">
  ...
  <a href="..." class="text-blue-500 print:text-black print:underline"> Link (shows as text when printed) </a>
</article>
